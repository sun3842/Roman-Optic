...
class Agent_common_model extends CI_Model
{
    ...
    public function db_login_authentication()
    {
        ...
        $query = $this->db->get_where('agent_login', array('agent_login_user_name' => $posted_login_user_name,'agent_login_active'=>1));
        ...
        $target_login_password_value=$login_table_row['agent_login_password_value'];
        ...
        if($this->validate_password($posted_login_password, $target_login_password_value))
        {
            ...
            $this->session->set_userdata('agent_login_id',$login_table_row['agent_login_id']);
            $this->session->set_userdata('agent_name',$login_table_row['agent_login_user_name']);
