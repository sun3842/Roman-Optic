    ...
    <form id="add_optician" method="POST" enctype="multipart/form-data">
        <div class="row">
            <div class="col-12 text-center my-5">
                ...
                <a href="<?php echo base_url('all_category')?>" class="btn-back" style="color: #35C9A7"><i class="fas fa-chevron-left"></i> BACK</a>
            </div>
        </div>
        <div class="row my-3">
            ...
            <div class="col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6 my-2">
                ...
                <input type="text" class="form-control" name="first_name" id="first_name" value="<?php echo $optician['team_member_first_name'];?>">
            </div>

            <div class="col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6 my-2">
                <label class="font-color"><?php echo $this->lang->line('last_name');?><span class="text-danger">*</span></label>
                <input type="text" class="form-control" name="last_name" id="last_name" value="<?php echo $optician['team_member_last_name'];?>">
            </div>

            <div class="col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6 my-2">
                <label class="font-color"><?php echo $this->lang->line('designation');?><span class="text-danger">*</span></label>
                <input type="text" class="form-control" name="designation" id="designation" value="<?php echo $optician['team_member_designation'];?>">
            </div>
            ...
            <div class="col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6 my-2">
                ...
                <select name="branch_name" id="branch_name" >
                    ...
                    <?php foreach($branch_names as $branch_name) {
                        ...
                        <option class="text-small" name="branch_name" id="branch_name" value="<?php echo $branch_name['branch_id'];?>" <?php echo ($branch_name['branch_id']==$optician['branch_id'])?'selected':'' ?>   > <?php echo $branch_name['branch_title'];  ?> </option>
            ...
            <div class="col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6 my-2">
                ...
                <input type="text" class="form-control" name="phone_no" id="phone_no" value="<?php echo $optician['team_member_phone'];?>">
            </div>
            <div class="col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6 my-2">
                <label class="font-color"><?php echo $this->lang->line('email');?></label>
                <input type="text" class="form-control" name="email" id="email" value="<?php echo $optician['team_member_email'];?>">
            </div>

            <div class="col-12 my-2">
                <label class="font-color"><?php echo $this->lang->line('about_and_service_details');?></label>
                <textarea name="service_details" id="service_details"><?php echo $optician['team_member_about_and_services'];?></textarea>
            </div>
            ...
            <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 box-off-white ml-3">
                <div class="row" id="upload_display_images" >


                    <div class='col-12 col-xs-12 col-sm-12 col-md-3 col-lg-3 pl-3 pb-4 photo-size'><img
                                src='<?php echo site_url($optician['team_member_image_location']); ?>' <?php echo($optician['team_member_image_location'] == null ? "hidden" : "") ?>
                                width='100%' id='output'>
                        <button type='button' id='del' onclick='remove_img(this)' class='btn btn-danger' <?php echo ($optician['team_member_image_location'] == null ? "hidden" : "")?>><?php echo $this->lang->line('delete');?></button>
                    </div>
