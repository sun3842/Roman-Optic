    ...
    <form id="job_form" method="post">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <input type="text" class="form-control" name="job_title" id="job_title" value="<?php echo $jobs['jobs_title'] ?>">
            </div>

            <div class="col-12">
                <label><?php echo $this->lang->line('job_context');?></label>
                <textarea name="job_context" id="job_context"><?php echo $jobs['jobs_context'] ?></textarea>
            </div>

            <div class="col-12">
                <label><?php echo $this->lang->line('job_educational_requirement');?></label>
                <textarea name="job_edu_req" id="job_edu_req" ><?php echo $jobs['jobs_educational_requirement'] ?></textarea>
            </div>

            <div class="col-12">
                <label><?php echo $this->lang->line('job_experience_requirement');?></label>
                <textarea name="job_exp_req" id="job_exp_req"><?php echo $jobs['jobs_experiences_requirement'] ?></textarea>
            </div>
            ...
            <div class="col-12 col-xs-12 col-sm-12 col-md-4 col-lg-4 my-4">
                ...
                <select name="currency_name" id="currency_name">
                    <?php foreach($currency as $curr) { ?>
                        <option value="<?php echo $curr['currency_id'] ?>" <?php echo ($curr['currency_id']==$jobs['ref_jobs_currency_id']) ? "selected" : "" ?> ><?php echo $curr['curency_name'] ?></option><?php } ?>
                </select>
            ...
            <div class="col-12 col-xs-12 col-sm-12 col-md-4 col-lg-4 my-3">
                ...
                <select name="job_position" id="job_position">
                    <?php foreach($jobs_position as $jobs_pos) { ?>
                        <option value="<?php echo $jobs_pos['job_position_id'] ?>" <?php echo ($jobs_pos['job_position_id']==$jobs['ref_jobs_position_id']) ? "selected" : "" ?>  ><?php echo $jobs_pos['job_position_name'] ?></option><?php } ?>
                </select>
            </div>
            ...
            <div class="col-12 col-xs-12 col-sm-12 col-md-4 col-lg-4 my-3">
                ...
                <select name="employment_status" id="employment_status">
                    <?php foreach($employment_status as $emp_status) { ?>
                        <option value="<?php echo $emp_status['employment_status_id'] ?>"<?php echo ($emp_status['employment_status_id']==$jobs['ref_jobs_employment_status_id']) ? "selected" : ""  ?>><?php echo $emp_status['employment_status_name'] ?></option><?php } ?>
                </select>
            </div>

            <div class="col-12 mt-5"><label class="text-medium"><input type="checkbox" name="salary_neg" id="salary_neg" <?php echo($jobs['jobs_salary_negotiable'] == 1) ? "checked" : null; ?>><span class="ml-2"><?php echo $this->lang->line('salary_negotiable');?></span></label></div>
            ...
            <div class="col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6 my-5">
                ...
                <input type="text" class="date-time-picker form-control"  name="choose_deadtime" placeholder="Select Date" id="choose_deadtime" value="<?php echo $jobs['jobs_deadline_date'] ?>">
            </div>

            <div class="col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6 my-5">
                <label><?php echo $this->lang->line('job_location');?></label>
                <input type="text" class="form-control" name="job_location" id="job_location" value="<?php echo $jobs['jobs_location'] ?>">
            </div>


            <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 my-3">
                <input type="submit" name="job_info_submit" id="job_info_submit" class="btn-common" value="<?php echo $this->lang->line('confirm');?>">
            </div>
...
<script type="text/javascript" rel="script">
    ...
    $(function () {
        $("#slider-range").slider({
           ...
           <?php $value = $jobs['jobs_salary_range'];
            $separate_value = (explode("-", $value));
                  ?>
            range: true,
            min: 100,
            max: 50000,
            values: [<?php echo $separate_value[0]?>, <?php echo $separate_value[1]?>],
