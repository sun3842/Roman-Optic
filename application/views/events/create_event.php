...
<div class="content">
    ...
    <div class="row">
        <div class="col-12 text-center my-5">
            <label class="page-heading "><?php echo $this->lang->line('create_event')?></label>
...
<form enctype="multipart/form-data" method="post" id="form_event">
    <div class="row">
        ...
        <div class="col-12">
            ...
            <textarea name="event_details" id="event_details"></textarea>
        </div>


        <div class="col-12 col-xs-12 col-sm-12 col-md-5 col-lg-5">
	        <label class="text-small"><?php echo $this->lang->line('event_duration')?> </label>
	        <input type="text" class="date-time-picker form-control" placeholder="Select Date" name="event_start_time" id="event_start_time">
        </div>
       ...
       <div class="col-12 col-xs-12 col-sm-12 col-md-5 col-lg-5 my-5">
          <input type="text" class="date-time-picker form-control" placeholder="END DATE AND TIME" name="event_end_time" id="event_end_time">
       </div>
        ...
        <div class="col-12 col-xs-12 col-sm-12 col-md-4 col-lg-4 my-3">
            ...
            <select name="event_region" id="event_region" disabled>
       ...
       <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="col-12">
         ...
         <div class="col-12">
            <div class="input-group mb-3">
                <input type="text" class="form-control " style="font-size: small;" placeholder="" disabled="">
            <div>
...
<!--    </div>-->
           ...
           <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 my-5 text-center">
            <input type="submit" class="btn-common-post-event" value="ADD EVENT" name="btn_add_event">
        </div> 
