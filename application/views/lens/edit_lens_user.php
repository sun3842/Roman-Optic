...
<div class="content">
    ...
    <label class="page-heading"><?php echo $this->lang->line('edit_lens_user')?></label>
    <form method="post" id="form_lens_user">
        <div class="row">
            ...
            <div class="col-12 my-4">
                ...
                <input type="text" class="form-control" name="user_name" id="user_name"  value="<?php echo $lens_user['downloaded_user_user_name']?>">
                <input type="hidden" name="user_id" id="user_id" value="<?php echo $lens_user['ref_lens_user_downloaded_user_id']?>">
            </div>
            ...
            <div class="col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6 my-3">
                ...
                <input type="text" class="form-control" name="user_first_name" id="user_first_name" value="<?php echo $lens_user['lens_user_first_name']?>">
            </div>
            <div class="col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6 my-3">
                <label class="text-small"><?php echo $this->lang->line('last_name')?><span class="text-danger">*</span></label>
                <input type="text" class="form-control" id="user_last_name" name="user_last_name" value="<?php echo $lens_user['lens_user_last_name']?>">
            </div>
            ...
            <div class="col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6">
                ...
                <input type="text" class="date-time-picker form-control" placeholder="Select Date" name="user_dob"
                       id="user_dob" value="<?php echo $lens_user['lens_user_birth_date']?>">
            </div>
            ...
            <div class="col-12 col-xs-12 col-sm-12 col-md-4 col-lg-4 my-3">
                ...
                <select name="user_country" id="user_country">
                    ...
                    <?php foreach ($countries AS $country) { ?>
                        <option value="<?php echo $country['countries_id'] ?>"  <?php echo($lens_user["lens_user_country_id"]==$country["countries_id"])?"selected":''?>><?php echo $country['countries_name'] ?></option>
                    <?php } ?>
                </select>
            </div>
            <div class="col-12 col-xs-12 col-sm-12 col-md-4 col-lg-4 my-3">
                <label class="text-small"><?php echo $this->lang->line('select_region')?></label>
                <select name="user_region" id="user_region" <?php if(!isset($regions)) echo'disabled'; ?>>
                    <option value=""><?php echo $this->lang->line('select_region')?></option>
                    <?php if(isset($regions)){ ?>
                        <?php foreach ($regions AS $region){ ?>
                            <option value="<?php echo $region['states_id'] ?>"  <?php echo($lens_user["lens_user_state_id"]==$region["states_id"])?"selected":''?>><?php echo $region['states_name'] ?></option>
                        <?php } ?>
                    <?php } ?>
                </select>
            </div>
            <div class="col-12 col-xs-12 col-sm-12 col-md-4 col-lg-4 my-3">
                ...
                <select name="user_city" id="user_city" <?php if(!isset($cities)) echo'disabled'; ?>>
                    <option value=""><?php echo $this->lang->line('select_city')?></option>
                    <?php if(isset($cities)){ ?>
                        <?php foreach ($cities AS $city){ ?>
                            <option value="<?php echo $city['cities_id'] ?>"  <?php echo($lens_user["lens_user_city_id"]==$city["cities_id"])?"selected":''?>><?php echo $city['cities_name'] ?></option>
                        <?php } ?>
                    <?php } ?>
                </select>
            </div>
            ...
            <div class="col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6 my-3">
                ...
                <input type="text" class="form-control" name="user_post_code" id="user_post_code" value="<?php echo $lens_user['lens_user_post_code']?>">
            </div>

            <div class="col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6 my-3">
                <label class="text-small"><?php echo $this->lang->line('email')?></label>
                <input type="email" class="form-control" name="user_mail" id="user_mail" value="<?php echo $lens_user['lens_user_email']?>">
            </div>
            ...
            <div class="col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6">
                ...
                <select name="user_phone_code" id="user_phone_code">
                    ...
                    <?php foreach ($countries AS $country) { ?>
                        <option value="<?php echo $country['countries_id'] ?>" <?php echo($lens_user["lens_user_country_id"]==$country["countries_id"])?"selected":''?>><?php echo '(' . $country['countries_sortname'] . ') ' . $country['countries_phonecode'] ?></option>
                    <?php } ?>
                </select>
            </div>
            ...
            <div class="col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6">
                ...
                <input type="text" class="form-control" name="user_phone" id="user_phone" value="<?php echo $lens_user['lens_user_phone']?>">
            </div>


            <div class="col-12 my-3">
                <label class="text-small"><?php echo $this->lang->line('address')?> <span class="text-red">*</span></label>
                <textarea id="user_address" name="user_address"><?php echo $lens_user['lens_user_address']?></textarea>
            </div>
            ...
            <div class="col-12" id="rightEye">
                <div class="row">
                    <div class="col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        ...
                        <input type="text" class="form-control" name="right_lens_name" id="right_lens_name" value="<?php echo $lens_user['lens_user_right_name']?>">
                    </div>

                    <div class="col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6 ">
                        <label class="text-small"><?php echo $this->lang->line('company_name')?></label>
                        <input type="text" class="form-control" name="right_company_name" id="right_company_name" value="<?php echo $lens_user['lens_user_right_company']?>">
                    </div>
                    ...
                    <div class="col-12 ">
                        ...
                        <select id="right_lens_type" name="right_lens_type" class="text-small">
                            ...
                            <?php foreach ($lens_types AS $lens_type) { ?>
                                <option value="<?php echo $lens_type['lens_type_id'] ?>" <?php echo($lens_user["ref_lens_user_right_lens_type_id"]==$lens_type['lens_type_id'])?"selected":''?>><?php echo $lens_type['lens_type_name'] ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    ...
                    <div class="col-12 col-xs-12 col-sm-12 col-md-3 col-lg-3 background-color div-sphere-power">
                        <input type="radio" name="right_sphere_power_type" id="right_sphere_power_plus" class="power-type"
                               value="right_sphere_power_plus" <?php echo($lens_user["lens_user_right_sphere"]>=0)?"checked":''?>><label for="right_sphere_power_plus" class="right-sphere sphere-power-type <?php echo($lens_user["lens_user_right_sphere"]>=0)?"power-active":''?>"><i
                                class="fas fa-plus"></i></label>
                        <input type="radio" name="right_sphere_power_type" id="right_sphere_power_minus" class="power-type"
                               value="right_sphere_power_minus" <?php echo($lens_user["lens_user_right_sphere"]<0)?"selected":''?>><label for="right_sphere_power_minus" class="right-sphere sphere-power-type <?php echo($lens_user["lens_user_right_sphere"]<0)?"power-active":''?>"><i
                                class="fas fa-minus"></i></label>
                    </div>

                    <div class="col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        <input type="text" class="form-control" value="<?php echo $lens_user["lens_user_right_sphere"]?>" name="right_sphere_power_value" id="right_sphere_power_value"
                               pattern="^[+|-]?\d+(\.\d+)">
                    </div>
                    ...
                    <div class="col-12 col-xs-12 col-sm-12 col-md-3 col-lg-3 background-color div-cylinder-power">
                        ...
                        <input type="radio" name="right_cylinder_power_type" id="right_cylinder_power_plus" class="power-type"
                               value="right_cylinder_power_plus"  <?php echo($lens_user["lens_user_right_cylinder"]>=0)?"checked":''?>><label for="right_cylinder_power_plus" class="right-cylinder cylinder-power-type <?php echo($lens_user["lens_user_right_cylinder"]>=0)?"power-active":''?>"><i
                        ...
                        <input type="radio" name="right_cylinder_power_type" id="right_cylinder_power_minus" class="power-type"
                               value="right_cylinder_power_minus" <?php echo($lens_user["lens_user_right_cylinder"]<0)?"checked":''?>><label for="right_cylinder_power_minus"
                                                                         class="right-cylinder cylinder-power-type <?php echo($lens_user["lens_user_right_cylinder"]<0)?"power-active":''?>"><i
                                class="fas fa-minus text-center"></i></label>
                    </div>

                    <div class="col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        <input type="text" class="form-control" name="right_cylinder_power_value" value="<?php echo $lens_user["lens_user_right_cylinder"]?>" id="right_cylinder_power_value"
                               pattern="^[+|-]?\d+(\.\d+)">
                    </div>
                    ...
                    <div class="col-12 col-xs-12 col-sm-12 col-md-4 col-lg-4">
                        ...
                        <input type="text" class="form-control" name="right_axis" id="right_axis" value="<?php echo $lens_user["lens_user_right_axis"]?>">
                    </div>

                    <div class="col-12 col-xs-12 col-sm-12 col-md-4 col-lg-4 ">
                        <label class="text-small"><?php echo $this->lang->line('addiction')?></label>
                        <input type="text" class="form-control" name="right_addiction" id="right_addiction" value="<?php echo $lens_user["lens_user_right_addiction"]?>">
                    </div>

                    <div class="col-12 col-xs-12 col-sm-12 col-md-4 col-lg-4 ">
                        <label class="text-small"><?php echo $this->lang->line('diameter')?></label>
                        <input type="text" class="form-control" id="right_diameter" name="right_diameter" value="<?php echo $lens_user["lens_user_right_diameter"]?>">
                    </div>
                    ...
                    <div class="col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        <label class="text-small"><?php echo $this->lang->line('lens_duration_in_days')?></label>
                        <input type="number" name="right_lens_duration" id="right_lens_duration" class="form-control" value="<?php echo $lens_user["lens_user_right_duration_day"]?>">
                    </div>

                    <div class="col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6 ">
                        <label class="text-small"><?php echo $this->lang->line('select_starting_date')?></label>
                        <input type="text" class="date-time-picker form-control" placeholder="Select Date"
                               id="right_start_date"
                               name="right_start_date" value="<?php echo $lens_user["lens_user_right_starting_date"]?>">
                    </div>
                </div>
            </div>
            <!-----------------------------------------------------------------left eye ------------------------------------------------------------------------------------------>
            <div class="col-12" id="leftEye" style="display: none;">
                <div class="row">
                    <div class="col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        <label class="text-small"><?php echo $lens_user["lens_name"]?></label>
                        <input type="text" class="form-control" name="left_lens_name" id="left_lens_name" value="<?php echo $lens_user['lens_user_left_name']?>">
                    </div>

                    <div class="col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6 ">
                        <label class="text-small"><?php echo $lens_user["company_name"]?></label>
                        <input type="text" class="form-control" name="left_company_name" id="left_company_name" value="<?php echo $lens_user['lens_user_left_company']?>">
                    </div>

                    <div class="col-12 ">
                        <label class="text-small"> <?php echo $lens_user["lens_type"]?></label>
                        <select id="left_lens_type" name="left_lens_type" class="text-small">
                            <option class="text-small" value="">SELECT</option>
                            <?php foreach ($lens_types AS $lens_type) { ?>
                                <option value="<?php echo $lens_type['lens_type_id'] ?>" <?php echo($lens_user["ref_lens_user_left_lens_type_id"]==$lens_type['lens_type_id'])?"selected":''?>><?php echo $lens_type['lens_type_name'] ?></option>
                            <?php } ?>
                        </select>
                    </div>

                    <div class="col-12 col-xs-12 col-sm-12 col-md-3 col-lg-3 ">
                        <label class="text-small"><?php echo $lens_user["sphere"]?> <span class="p-2">:</span></label>
                    </div>

                    <div class="col-12 col-xs-12 col-sm-12 col-md-3 col-lg-3 background-color div-sphere-power">
                        <input type="radio" name="left_sphere_power_type" id="left_sphere_power_plus" class="power-type"
                               value="left_sphere_power_plus" <?php echo($lens_user["lens_user_left_sphere"]>=0)?"checked":''?>><label for="left_sphere_power_plus" class="left-sphere sphere-power-type <?php echo($lens_user["lens_user_left_sphere"]>=0)?"power-active":''?>"><i
                                class="fas fa-plus"></i></label>
                        <input type="radio" name="left_sphere_power_type" id="left_sphere_power_minus" class="power-type"
                               value="left_sphere_power_minus" <?php echo($lens_user["lens_user_left_sphere"]<0)?"checked":''?>><label for="left_sphere_power_minus" class="left-sphere sphere-power-type <?php echo($lens_user["lens_user_left_sphere"]<0)?"power-active":''?>"><i
                                class="fas fa-minus"></i></label>
                    </div>

                    <div class="col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        <input type="text" class="form-control" name="left_sphere_power_value" id="left_sphere_power_value"
                               pattern="^[+|-]?\d+(\.\d+)" value="<?php echo$lens_user["lens_user_left_sphere"];?>">
                    </div>


                    <div class="col-12 col-xs-12 col-sm-12 col-md-3 col-lg-3 ">

                        <label class="text-small"><?php echo $lens_user["cylinder"]?> <span class="p-2">:</span></label>
                    ...
                    <div class="col-12 col-xs-12 col-sm-12 col-md-3 col-lg-3 background-color div-cylinder-power">
                        ...
                        <input type="radio" name="left_cylinder_power_type" id="left_cylinder_power_plus" class="power-type"
                               value="left_cylinder_power_plus" <?php echo($lens_user["lens_user_left_cylinder"]>=0)?"checked":''?>><label for="left_cylinder_power_plus" class="left-cylinder cylinder-power-type <?php echo($lens_user["lens_user_left_cylinder"]>=0)?"power-active":''?>"><i
                                class="fas fa-plus text-center"></i></label>
                        <input type="radio" name="left_cylinder_power_type" id="left_cylinder_power_minus" class="power-type"
                               value="left_cylinder_power_minus" <?php echo($lens_user["lens_user_left_cylinder"]<0)?"checked":''?>><label for="left_cylinder_power_minus"
                                                                        class="left-cylinder cylinder-power-type <?php echo($lens_user["lens_user_left_cylinder"]<0)?"power-active":''?>"><i
                                class="fas fa-minus text-center"></i></label>
                    </div>

                    <div class="col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        <input type="text" class="form-control" name="left_cylinder_power_value" id="left_cylinder_power_value"
                               pattern="^[+|-]?\d+(\.\d+)" value="<?php echo $lens_user["lens_user_left_cylinder"]?>">
                    </div>


                    <div class="col-12 col-xs-12 col-sm-12 col-md-4 col-lg-4">
                        <label class="text-small"><?php echo $lens_user["axis"]?></label>
                        <input type="text" class="form-control" name="left_axis" id="left_axis" value="<?php echo $lens_user["lens_user_left_axis"]?>">
                    </div>

                    <div class="col-12 col-xs-12 col-sm-12 col-md-4 col-lg-4 ">
                        <label class="text-small"><?php echo $lens_user["addiction"]?></label>
                        <input type="text" class="form-control" name="left_addiction" id="left_addiction" value="<?php echo $lens_user["lens_user_left_addiction"]?>">
                    </div>

                    <div class="col-12 col-xs-12 col-sm-12 col-md-4 col-lg-4 ">
                        <label class="text-small"><?php echo $lens_user["diameter"]?></label>
                        <input type="text" class="form-control" id="left_diameter" name="left_diameter" value="<?php echo $lens_user["lens_user_left_diameter"]?>">
                    </div>

                    <div class="col-12">
                        <label class="text-weight-bold pl-3"><?php echo $lens_user["set_timer_left_eye_lens"]?></label>
                    </div>


                    <div class="col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        <label class="text-small"><?php echo $lens_user["lens_duration"]?></label>
                        <input type="number" name="left_lens_duration" id="left_lens_duration" class="form-control" value="<?php echo $lens_user["lens_user_left_duration_day"]?>">
                    </div>

                    <div class="col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6 ">
                        <label class="text-small"><?php echo $lens_user["select_starting_date"]?></label>
                        <input type="text" class="date-time-picker form-control" placeholder="Select Date"
                               id="left_start_date"
                               name="left_start_date" value="<?php echo $lens_user["lens_user_left_starting_date"]?>">
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 my-3">
                <button class="btn-common" type="submit" name="eye"><?php echo $lens_user["confirm"]?></button>
            </div>
...
//        alert(temp_user_name);
        if (temp_user_name != '') {
            $.ajax({
                url: '<?php echo site_url("add_lens_user")?>',
                type: 'POST',
