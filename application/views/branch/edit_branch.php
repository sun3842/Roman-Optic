...
<div class="content">
    ...
    <form name="contact_us_form" id="contact_us_form" action="<?php echo site_url('edit_branch/'.$branch['branch_id']);?>" method="post">
        ...
        <div class="row">
            ...
            <div class="col-12 my-3">
                ...
                <input type="text" class="form-control" name="shop_name" value="<?php echo $branch['branch_title'];?>">
            </div>
            <div class="col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6">
                <label>SHOP REGISTER NO.</label>
                <input type="text" class="form-control" name="reg_no" value="<?php echo $branch['branch_reg_no'];?>">
            </div>
            <div class="col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6">
            ...
            <div class="col-12 my-3">
                ...
                <textarea name="shop_details"><?php echo $branch['branch_about_us'];?></textarea>
            </div>
            <div class="col-12">
            ...
            <div class="col-12 col-xs-12 col-sm-12 col-md-4 col-lg-4 my-3">
                ...
                <select name="country_list" id="country_list">
                    ...
                    {
                        ?>
                        <option value="<?php echo $country['countries_id'];?>" <?php echo $branch['ref_branch_countries_id']==$country['countries_id']?"SELECTED":"";?>><?php echo $country['countries_name'];?></option>
                        <?php
                    }
                    ?>
            ...
            <div class="col-12 col-xs-12 col-sm-12 col-md-8 col-lg-8 my-3">
                ...
                <input type="text" class="form-control" name="shop_address" value="<?php echo $branch['branch_address'];?>">
            </div>
            <div class="col-12 col-xs-12 col-sm-12 col-md-4 col-lg-4 my-3">
                <label>POST CODE<span class="text-red"><b>*</b></span></label>
                <input type="text" class="form-control" name="post_code" value="<?php echo $branch['branch_post_code'];?>">
            </div>
            ...
            <div class="col-12 col-xs-12 col-sm-12 col-md-4 col-lg-4 my-3">
                ...
                <select name="phone_code_country_id" id="phone_code_country_id">
                    ...
                    {
                        ?>
                        <option value="<?php echo $country['countries_id'];?>" <?php echo $branch['ref_branch_country_phone_code_country_id']==$country['countries_id']?"SELECTED":"";?>><?php echo $country['countries_name']."-".$country['countries_sortname']."-".$country['countries_phonecode'];?></option>
                        <?php
                    }
                    ?>
                </select>
            ...
            <div class="col-12 col-xs-12 col-sm-12 col-md-4 col-lg-4 my-3">
                <label>PHONE (COUNTRY CODE)<span class="text-red"><b>*</b></span></label>
                <input type="text" class="form-control" name="country_phone_code" id="country_phone_code" value="<?php echo $branch['branch_country_phone_code'];?>" readonly>

            </div>

            <div class="col-12 col-xs-12 col-sm-12 col-md-4 col-lg-4 my-3">
                <label>PHONE NUMBER<span class="text-red"><b>*</b></span></label>
                <input type="text" class="form-control" name="phone_number" value="<?php echo $branch['branch_contact_number'];?>">
            </div>
            <!--
            ...
            <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 my-3">
                <label>EMAIL</label>
                <input type="email" class="form-control" name="shop_email" value="<?php echo $branch['branch_email_address'];?>">
            </div>
            <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 my-3">
                <label>WEBSITE</label>
                <input type="text" class="form-control" name="shop_website" value="<?php echo $branch['branch_web_site_link'];?>">
            </div>

            <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 my-3">
                <label>FACEBOOK</label>
                <input type="text" class="form-control" name="shop_facebook" value="<?php echo $branch['branch_facebook'];?>">
            </div>

            <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 my-3">
                <label>GOOGLE PLUS</label>
                <input type="text" class="form-control" name="shop_google_plus" value="<?php echo $branch['branch_google_plus'];?>">
            </div>

            <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 my-3">
                <label>LINKEDIN</label>
                <input type="text" class="form-control" name="shop_linkedin" value="<?php echo $branch['branch_linkedin'];?>">
            </div>

            <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 my-3">
                <label>TWITTER</label>
                <input type="text" class="form-control" name="shop_twitter" value="<?php echo $branch['branch_twitter'];?>">
            </div>

            <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 my-3">
                <label>INSTAGRAM</label>
                <input type="text" class="form-control" name="shop_instagram" value="<?php echo $branch['branch_instagram'];?>">
            </div>

            <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 my-3">
                <label>TIMETABLE<span class="text-red"><b>*</b></span></label>
                <select name="select_branch_time_table" id="select_branch_time_table">
                    <option value="0" <?php echo $branch['timetable_type']==0?"SELECTED":"";?>>NOT AVAILABLE</option>
                    <option value="1" <?php echo $branch['timetable_type']==1?"SELECTED":"";?>>ALWAYS OPEN</option>
                    <option value="2" <?php echo $branch['timetable_type']==2?"SELECTED":"";?>>SELECTED TIMETABLE</option>
                </select>
            </div>
...
<script type="text/javascript" rel="script">
    ...
    var edit_timetable_type=<?php echo $branch['timetable_type'];?>;

    if(edit_timetable_type==2)
    {
    ...
    else
    {
        ...
        {
            var selected_country_id=<?php echo $branch['ref_branch_countries_id'];?>;
        var selected_state_id=<?php echo $branch['ref_branch_states_id'];?>;
        var selected_city_id=<?php echo $branch['ref_branch_cities_id'];?>;
        var selected="";


        $.ajax({
            type: 'POST',
            url: '<?php echo base_url();?>Common/for_ajax_get_all_states_by_country_id',
            ...
            success: function (result) {
                ...
                {
                    if(selected_state_id==result[i]['states_id'])
                    {
                        selected="SELECTED";
                    }
                    else
                    ...
                    options=options+"<option value='"+result[i]['states_id']+"' "+selected+">"+result[i]['states_name']+"</option>";
                }
               // $('#city_list').html("");
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url();?>Common/for_ajax_get_all_cities_by_state_id',
            ...
            success: function (result) {
                ...
                for(var i=0;i<result.length;i++)
                {
                    if(selected_city_id==result[i]['cities_id'])
                    {
                        selected="SELECTED";
                    }
                    else
                    ...
                    options=options+"<option value='"+result[i]['cities_id']+"' "+selected+">"+result[i]['cities_name']+"</option>";
                }
...
*/
    ...
    put_timetable_values();
    function put_timetable_values()
    {
        var time_table_option;
        var status_value="";
        var tag="";
        var timetable_day=0;
        var sat=1,sun=2,mon=3,tues=4,wed=5,thurs=6,fri=7;
        var is_sat_open=<?php echo $branch['is_sat_open'];?>;
        var sat_time="<?php echo $branch['sat_time'];?>";

        var is_sun_open=<?php echo $branch['is_sun_open'];?>;
        var sun_time="<?php echo $branch['sun_time'];?>";

        var is_mon_open=<?php echo $branch['is_mon_open'];?>;
        var mon_time="<?php echo $branch['mon_time'];?>";

        var is_tues_open=<?php echo $branch['is_tues_open'];?>;
        var tues_time="<?php echo $branch['tues_time'];?>";

        var is_wed_open=<?php echo $branch['is_wed_open'];?>;
        var wed_time="<?php echo $branch['wed_time'];?>";

        var is_thurs_open=<?php echo $branch['is_thurs_open'];?>;
        var thurs_time="<?php echo $branch['thurs_time'];?>";

        var is_fri_open=<?php echo $branch['is_fri_open'];?>;
        var fri_time="<?php echo $branch['fri_time'];?>";

        if(is_sat_open==1)
        {
            status_value=is_sat_open==1?"OPEN":"CLOSE";
            tag="sat";
            timetable_day=sat;
            time_table_option=is_sat_open;

            $("#"+tag+"_status").html(status_value);

            $("#h_"+tag+"_status").val(time_table_option);
            var sat_array=sat_time.split(",");

            slot_no_array[timetable_day]=sat_array.length;

            $("#h_"+tag+"_total_slot").val(slot_no_array[timetable_day]);

            for(var i=1;i<=sat_array.length;i++)
            {
                var db_time_array=sat_array[i-1].split("-");
        ...
        if(is_sun_open==1)
        {
            status_value=is_sun_open==1?"OPEN":"CLOSE";
            tag="sun";
            timetable_day=sun;
            time_table_option=is_sun_open;

            $("#"+tag+"_status").html(status_value);

            $("#h_"+tag+"_status").val(time_table_option);
            var sun_array=sun_time.split(",");

            slot_no_array[timetable_day]=sun_array.length;

            $("#h_"+tag+"_total_slot").val(slot_no_array[timetable_day]);

            for(var i=1;i<=sun_array.length;i++)
            {
                var db_time_array=sun_array[i-1].split("-");
                $("#"+tag+"_slot_start_time_"+i).html(db_time_array[0]);
                $("#"+tag+"_slot_end_time_"+i).html(db_time_array[1]);
                $("#"+tag+"_delete_slot_"+i).html('<a href="javascript:void(0)" class="action action-delete" onclick="delet_time_slot('+timetable_day+','+i+');"><i class="far fa-trash-alt"></i></a>');
        ...
        if(is_mon_open==1)
        {
            status_value=is_mon_open==1?"OPEN":"CLOSE";
            tag="mon";
            timetable_day=mon;
            time_table_option=is_mon_open;

            $("#"+tag+"_status").html(status_value);

            $("#h_"+tag+"_status").val(time_table_option);
            var mon_array=mon_time.split(",");


            slot_no_array[timetable_day]=mon_array.length;

            $("#h_"+tag+"_total_slot").val(slot_no_array[timetable_day]);

            for(var i=1;i<=mon_array.length;i++)
            {
                var db_time_array=mon_array[i-1].split("-");
                $("#"+tag+"_slot_start_time_"+i).html(db_time_array[0]);
                $("#"+tag+"_slot_end_time_"+i).html(db_time_array[1]);
                $("#"+tag+"_delete_slot_"+i).html('<a href="javascript:void(0)" class="action action-delete" onclick="delet_time_slot('+timetable_day+','+i+');"><i class="far fa-trash-alt"></i></a>');
...
//Closed
        ...
        if(is_tues_open==1)
        {
            status_value=is_tues_open==1?"OPEN":"CLOSE";
            tag="tue";
            timetable_day=tues;
            time_table_option=is_tues_open;

            $("#"+tag+"_status").html(status_value);

            $("#h_"+tag+"_status").val(time_table_option);
            var tues_array=tues_time.split(",");

            slot_no_array[timetable_day]=tues_array.length;

            $("#h_"+tag+"_total_slot").val(slot_no_array[timetable_day]);

            for(var i=1;i<=tues_array.length;i++)
            {
                var db_time_array=tues_array[i-1].split("-");
                $("#"+tag+"_slot_start_time_"+i).html(db_time_array[0]);
                $("#"+tag+"_slot_end_time_"+i).html(db_time_array[1]);
                $("#"+tag+"_delete_slot_"+i).html('<a href="javascript:void(0)" class="action action-delete" onclick="delet_time_slot('+timetable_day+','+i+');"><i class="far fa-trash-alt"></i></a>');
...
//Closed
        ...
        if(is_wed_open==1)
        {
            status_value=is_wed_open==1?"OPEN":"CLOSE";
            tag="wed";
            timetable_day=wed;
            time_table_option=is_wed_open;

            $("#"+tag+"_status").html(status_value);

            $("#h_"+tag+"_status").val(time_table_option);
            var wed_array=wed_time.split(",");

            slot_no_array[timetable_day]=wed_array.length;

            $("#h_"+tag+"_total_slot").val(slot_no_array[timetable_day]);

            for(var i=1;i<=wed_array.length;i++)
            {
                var db_time_array=wed_array[i-1].split("-");
                $("#"+tag+"_slot_start_time_"+i).html(db_time_array[0]);
                $("#"+tag+"_slot_end_time_"+i).html(db_time_array[1]);
                $("#"+tag+"_delete_slot_"+i).html('<a href="javascript:void(0)" class="action action-delete" onclick="delet_time_slot('+timetable_day+','+i+');"><i class="far fa-trash-alt"></i></a>');
...
//Closed
        ...
        if(is_thurs_open==1)
        {
            status_value=is_thurs_open==1?"OPEN":"CLOSE";
            tag="thurs";
            timetable_day=thurs;
            time_table_option=is_thurs_open;

            $("#"+tag+"_status").html(status_value);

            $("#h_"+tag+"_status").val(time_table_option);
            var thurs_array=thurs_time.split(",");

            slot_no_array[timetable_day]=thurs_array.length;

            $("#h_"+tag+"_total_slot").val(slot_no_array[timetable_day]);

            for(var i=1;i<=thurs_array.length;i++)
            {
                var db_time_array=thurs_array[i-1].split("-");
                $("#"+tag+"_slot_start_time_"+i).html(db_time_array[0]);
                $("#"+tag+"_slot_end_time_"+i).html(db_time_array[1]);
                $("#"+tag+"_delete_slot_"+i).html('<a href="javascript:void(0)" class="action action-delete" onclick="delet_time_slot('+timetable_day+','+i+');"><i class="far fa-trash-alt"></i></a>');
